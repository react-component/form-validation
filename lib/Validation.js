...
class Validation extends React.Component {
  ...
  getSchema(validator) {
    ...
    var fieldName;
    var rules;
    if (!validator.props.field){
      rules = validator.props.rules;
      ...
      var modelName;
      [modelName, fieldName ] =  validator.props.field.split(".");
      ret[fieldName] = this.descriptors[modelName][fieldName];
    }
    return ret;
  }
